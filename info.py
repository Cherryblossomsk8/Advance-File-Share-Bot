...
BOT_TOKEN = environ.get('BOT_TOKEN', "7434968604:AAH77mvXQ4lyuWvasdde3smCRkvW3xxU-0g") 
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001866788069').split()]
...
REQ_CHANNEL = environ.get("REQ_CHANNEL", '-1002063768861')
REQ_CHANNEL = int(REQ_CHANNEL) if REQ_CHANNEL and id_pattern.search(REQ_CHANNEL) else False
JOIN_REQS_DB = environ.get("JOIN_REQS_DB", DATABASE_URI)

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-2054016064'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001866788069')).split()]
